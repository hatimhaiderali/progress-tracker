...
function updateCurrentLoggingDate() {
    ...
    if (startDateValue) {
        ...
        document.getElementById('currentLoggingDate').innerHTML = `<span>Today:</span> ${formatDate(currentLoggingDate)}`; // Use formatted date
    } else {
        document.getElementById('currentLoggingDate').textContent = ''; // Clear if no start date
    }
}
